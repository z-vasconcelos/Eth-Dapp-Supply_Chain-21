...
contract('SupplyChain', function(accounts) {
    ...
    var sku = 1 //b1 b2  0 
    var upc = 1 //b1 b2  1
    const ownerID = accounts[0] //b1 2
    const originFarmerID = accounts[1] //b1 3
    const originFarmName = "John Doe" //b1 4
    const originFarmInformation = "Yarray Valley" //b1 5
    const originFarmLatitude = "-38.239770" //b1 6
    const originFarmLongitude = "144.341490" //b1 7
    var productID = sku + upc //b2 2
    const productNotes = "Best beans for Espresso" //b2 3
    const productPrice = Web3.utils.toWei("1", "ether")//b2 4
    var itemState = 0 //b2 5
    const distributorID = accounts[2] //b2 6
    const retailerID = accounts[3] //b2 7
    const consumerID = accounts[4] //b2 8
    const emptyAddress = '0x00000000000000000000000000000000000000' //b2 9
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        //ref: https://knowledge.udacity.com/questions/50169
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()ß
        const resultBufferOne = await supplyChain.fetchItemBufferOne.call(upc)
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[5], 7, 'Error: Invalid itemState -> ' + resultBufferTwo[5]);
